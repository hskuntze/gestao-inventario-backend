...
public class TangivelDTO {
	...
	public String toString() {
		return "TangivelDTO [id=" + id + ", idPatrimonial=" + idPatrimonial + ", categoria=" + categoria
				+ ", descricao=" + descricao + ", area=" + area + ", localizacao=" + localizacao + ", responsavel="
				+ responsavel + ", usuarioResponsavel=" + usuarioResponsavel + ", fornecedor=" + fornecedor
				+ ", dataAquisicao=" + dataAquisicao + ", codigoSerie=" + codigoSerie + ", observacoes=" + observacoes
				+ ", linkDocumento=" + linkDocumento + ", estadoConservacao=" + estadoConservacao + "]";
	}
}